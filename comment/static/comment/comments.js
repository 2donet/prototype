...
//         // Check if the form already has a submit listener
//         // This helps identify if the event is being attached
//         const currentListeners = addCommentForm.hasAttribute('data-listener-attached');
//         if (!currentListeners) {
//             console.log('Attaching submit event listener to form');
//             addCommentForm.setAttribute('data-listener-attached', 'true');
//         } else {
//             console.warn('Form already has listener attached - possible duplicate script loading');
//         }
//     } else {
//         console.error('Could not find add-comment-form! Check that the form has id="add-comment-form"');
//     }
// });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const addCommentForm = document.getElementById('add-comment-form');
    if (addCommentForm) {
        console.log('Found add-comment-form:', addCommentForm);
